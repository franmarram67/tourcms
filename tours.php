...
include('tourcms-php-main/src/TourCMS.php');
...
<head>
	...
	<script type="text/javascript">
		window._wpemojiSettings = {
			...
			"svgExt": ".svg",
			"source": {
				"concatemoji": "https:\/\/wordpress.tourcms.com\/wp-includes\/js\/wp-emoji-release.min.js?ver=5.8.2"
			}
		};
		! function(e, a, t) {
...
<![endif]-->
	<link rel="https://api.w.org/" href="https://wordpress.tourcms.com/wp-json/" />
	<link rel="EditURI" type="application/rsd+xml" title="RSD" href="https://wordpress.tourcms.com/xmlrpc.php?rsd" />
	...
	<link rel="pingback" href="https://wordpress.tourcms.com/xmlrpc.php">
	<style type="text/css">
		#page-sub-header {
			background: #ffffff;
		}
			...
			<div class="container">
				<div class="row">
					<div id="container">
						...
						<?php
						//Looking for tour_name, tour_url, summary, thumbnail_image, duration,
						//description, location & from_price
											...
											<div id="c-49-d" class="carousel slide" data-interval="false">
												<div class="carousel-inner">
													<div class="carousel-item active">
														<img class="d-block w-100" src="<?php echo $thumbnail_image; ?>" alt="">
													</div>
												</div>
											</div>
										</div>
										<a href="<?php echo $tour_url; ?>"><span class="dummy"></span><span class="dummy-upper-right"></span></a>
										<div class="card-body">
											<div class="left">
												<span class="tourcms-badge-tourtype-horizontal"><a href="https://wordpress.tourcms.com/tours-by-type/day-tours/" rel="tag">Day tours</a></span><span class="tourcms-badge-location-horizontal"> <a href="https://wordpress.tourcms.com/tours-by-location/berlin/" rel="tag"><?php echo $location; ?></a></span>
											</div>
											<div class="right price-panel">
												<p class="tourcms-card-text price-label" style="">Book now</p>
												<p class="tourcms-card-text price"><span class='fromprice'>from &#8364;<?php echo $from_price; ?></span></p>
											</div>

											<div class="card-meta-right">
												<h5 class="tourcms-card-title"><?php echo $tour_name; ?></h5>
												<p class="tourcms-card-text tourcms_wp_summary"><?php echo $summary; ?></p>
												<p class="tourcms-card-text"> <b>Duration:</b> <?php echo $duration; ?> hours</p>
							...
							<div class="col-12 col-md-6 col-lg-4 col-xl-3">
								<div class="card tour-mobile">
									...
									<div class="card-body">
										...
										<div style="margin-top:-0.8rem;"><span class="badge badge-location"> <a href="https://wordpress.tourcms.com/tours-by-location/berlin/" rel="tag"><?php echo $location; ?></a></span><span class="badge badge-tourtype"><a href="https://wordpress.tourcms.com/tours-by-type/day-tours/" rel="tag">Day tours</a></span></div>
										<!--              <p class="card-text"><i class="fas fa-history" style=""></i> <b>Duration:</b> 4 hours</p>-->
										<p class="tourcms-card-text"><?php echo $summary; ?></p>
									</div>
									<div class="card-footer bg-transparent">
										<p class="tourcms-card-text tour-mobile-footer-left"> <b>Duration:</b> <?php echo $duration; ?> hours<br></p>
										<p class="tourcms-card-text tour-mobile-footer-right" style=""><a href="<?php echo $tour_url; ?>">Book now <span class='fromprice'>from &#8364;<?php echo $from_price; ?></span></a><br></p>
									</div>
								</div>
							</div>
